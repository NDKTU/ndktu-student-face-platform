...
function App() {
  ...
  return (
    <ErrorBoundary>
      <AuthProvider>
        {/* basename Vite'ning `base` sozlamasidan olinadi (/legacy/).
            import.meta.env.BASE_URL oxirida "/" bilan keladi, react-router
            esa uni istamaydi — shuning uchun kesib tashlanadi. */}
