"""Yashirish funksiyasi 2026-09-11 da kommentga olindi, shu bilan bu testlar ham.

Nima tekshirilgani va nega — quyida saqlangan. Funksiya qaytarilsa, bu faylni
kommentdan chiqarish kifoya (`app/core/utils/visibility.py` ga qarang).
"""
