                            ...
                            <div className="mt-4 flex flex-col gap-2">
                                {data.methods.map(method => {
                                    ...
                                    return (
                                        <div
                                            key={method.id}
                                            className="flex flex-col gap-3 rounded-xl border border-border bg-background px-4 py-3 transition-colors hover:border-primary/30 hover:bg-accent/30 sm:flex-row sm:items-center sm:gap-4"
                                        >
                                            ...
                                            <div className="flex items-center justify-between gap-3 sm:justify-end">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
