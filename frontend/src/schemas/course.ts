...
// nom fan/guruh/tur/semestrdan yig'iladi, qolganlari esa serverda fan va
// guruhdan aniqlanadi.
export const courseSchema = z.object({
    teacher_id: z.string().min(1, "O'qituvchi tanlanishi shart"),
    subject_id: z.string().min(1, 'Fan tanlanishi shart'),
    course_type: z.enum(['lecture', 'practice', 'lab', 'seminar'], {
        message: 'Mashg\'ulot turi tanlanishi shart',
    }),
